    ...
    <table class="form-table">
        <tbody>
            ...
            <tr class="user-homey_author_airbnb-wrap">
                ...
                <td><input type="text" name="homey_author_airbnb" id="homey_author_airbnb" value="<?php echo esc_url( get_the_author_meta( 'homey_author_airbnb', $user->ID ) ); ?>" class="regular-text"></td>
            </tr>

            <tr class="user-homey_author_trip_advisor-wrap">
                <th><label for="homey_author_trip_advisor"><?php echo esc_html__('Trip Advisor Url', 'homey'); ?></label></th>
                <td><input type="text" name="homey_author_trip_advisor" id="homey_author_trip_advisor" value="<?php echo esc_url( get_the_author_meta( 'homey_author_trip_advisor', $user->ID ) ); ?>" class="regular-text"></td>
            </tr>
        </tbody>
    </table>
